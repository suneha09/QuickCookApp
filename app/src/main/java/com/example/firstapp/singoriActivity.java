...
public class singoriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singori);  // Link to the XML layout file
    ...
    private void populateRecipeData() {
        ...
        recipeImage.setImageResource(R.drawable.singori);  // 'singori' image in res/drawable

        // Set the recipe title
        recipeTitle.setText("SINGORI");
