...
public class JammuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFastFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JammuActivity.this, JammufastfoodActivity.class);
        ...
        btnSweetDishes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuActivity.this, JammusweetdishActivity .class);
                startActivity(intent);
            }
        });
        ...
        btnDrinks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuActivity.this, JammudrinksActivity.class);
                startActivity(intent);
            }
        });
    }
